...
<body class="flex row">
    ...
    <script src="https://cdn.tiny.cloud/1/<?php echo $_ENV['EDITOR_KEY'] ?>/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
    ...
    <script>
        tinymce.init({
            ...
            toolbar: 'undo redo | blocks fontfamily fontsize | bold italic underline | link table | align lineheight | checklist numlist bullist indent outdent | emoticons charmap | removeformat',
