...
<body>
    ...
    <header class="flex a-center j-between normal-font small-sz">
        ...
        <a href="" class="newsletter-button">Newsletter</a>
    ...
    <main class="container">
        ...
        <section class="hero flex j-between f-center f-width">
            ...
            <section class="qr-container over-hidden">
        ...
        <section class="sobrenos flex col a-center" id="about-us">
            <section class="Podcast-info flex a-center col t-center f-width">
                ...
                <a href="" class="newsletter-button"><h2>Saber mais</h2></a>
            </section>
        ...
        <section class="newsletter content flex col a-center">
            ...
            <a href="" class="newsletter-button"><h2>Ver mais</h2></a>
        </section>
